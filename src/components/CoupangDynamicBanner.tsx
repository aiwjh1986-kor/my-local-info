...
export default function CoupangDynamicBanner() {
  ...
  useEffect(() => {
    ...
    // 2단계: g.js 로드 완료 후 배너 초기화
    gScript.onload = () => {
      const initScript = document.createElement("script");
      initScript.textContent = `new PartnersCoupang.G({"id":985786,"trackingCode":"AF1183921","subId":null,"template":"carousel","width":"1000","height":"170"});`;
