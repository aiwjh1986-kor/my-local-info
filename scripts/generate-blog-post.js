...
2. 분량: 한글 공백 포함 최소 1,500자 이상으로, 경제/문화 등 전문적인 분석을 포함하여 매우 상세하고 길게 작성할 것.
3. 내용 구성: 흥미로운 도입부 -> 상세 내용 -> 추천 이유 3가지 -> 팁.
4. 형식: 마크다운 형식을 사용. 다른 설명 없이 마크다운 내용만 출력해.
5. 파일명 키워드: 글 마지막에 FILENAME_KEYWORD: [keyword] 형식으로 영문 키워드 1개를 꼭 포함해줘.
